...
-- BEGIN 002_add_member_role.sql
alter type public.user_role add value if not exists 'member';

-- END 002_add_member_role.sql

-- BEGIN 003_member_access_model.sql
...
-- END 003_member_access_model.sql

-- BEGIN 004_member_paid_service_insert.sql
...
-- END 004_member_paid_service_insert.sql

-- BEGIN 005_service_photos_bucket.sql
...
-- END 005_service_photos_bucket.sql

-- BEGIN 006_photo_delete_policies.sql
...
-- END 006_photo_delete_policies.sql

-- BEGIN 007_service_number_and_api_status.sql
...
-- END 007_service_number_and_api_status.sql

-- BEGIN 008_api_tokens.sql
...
-- END 008_api_tokens.sql

-- BEGIN 009_api_token_history.sql
